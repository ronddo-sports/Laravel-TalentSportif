...
class FanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.Entities.fan.index', compact('fan'));
    }
    ...
    {
        return view('admin.Entities.fan.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.Entities.fan.show', compact('fan'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.Entities.fan.edit', compact('fan'));
    }
