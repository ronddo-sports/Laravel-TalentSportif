...
class CartonController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.Entities.carton.index', compact('carton'));
    }
    ...
    {
        return view('admin.Entities.carton.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin.Entities.carton');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.Entities.carton.show', compact('carton'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.Entities.carton.edit', compact('carton'));
    }
