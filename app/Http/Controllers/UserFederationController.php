...
class UserFederationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.user-federation.index', compact('userfederation'));
    }
    ...
    {
        return view('admin.user-federation.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.user-federation.show', compact('userfederation'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.user-federation.edit', compact('userfederation'));
    }
