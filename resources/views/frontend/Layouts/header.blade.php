<div id="header" class="navbar-fixed-top">
    <div id="first-header">
        ...
        <form id="search-form" action="{{route('general.search')}}">
            <div class="input-group" id="adv-search">
                <input type="text" class="form-control" name="keyword" placeholder="Discipline, Sportifs..."/>
        ...
        <div class="container">
            ...
            @else
                ...
                <ul id="menu" class="nav navbar-nav" style="float: left;z-index: 9999999">
                    ...
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="glyphicon glyphicon-cog"></i><i class="caret"></i></a>
                        <ul class="dropdown-menu">
                            <li><a href="{{route('about')}}"><i class="glyphicon glyphicon-question-sign"></i>A Propos</a></li>
                            <li><a href="/about#condition">Conditions</a></li>
                            <li><a href="{{route('about')}}"><i class="glyphicon glyphicon-envelope"></i> Assistance</a></li>
                    ...
                    <li>
                        <a href="#" onmouseover="chngwhitef()" onmouseleave="chngbluef()">
                            <img id="fans" src="/icon/MES%20FAN.png">
                            <img id="fans2" src="/icon/MES%20FAN2.png" style="display: none"><span>1</span></a></li>
    
                    <li><a href="{{route('my.messagerie')}}" onmouseover="chngwhite()" onmouseleave="chngblue()" title="messages">
                    ...
                    <li><a href="{{route('about')}}" onmouseover="chngwhiten()" onmouseleave="chngbluen()" title="messages">
                     ...
                     <li><i style="font-style: normal" class="myAccount" onclick="window.location.href = '/home'">
                             <img style="height: 27px;border-right: 2px solid #298ffd;" src="{{ profilePicFromUserId(Auth::id()) }}?w=30&h=30&fit=crop">
                             <strong>{{ explode(' ',Auth::user()->username)[0] }}</strong>
                         </i>
                     </li>
                </ul>
