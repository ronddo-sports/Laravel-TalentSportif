                       ...
                       <a href="{{ url('/admin/photo/create') }}" class="btn btn-success btn-sm" title="Add New Photo">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>ID</th><th>Url</th><th>Media Id</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($photo as $item)
                                    <tr>
                                        <td>{{ $item->id }}</td>
                                        <td>{{ $item->url }}</td><td>{{ $item->media_id }}</td>
                                        <td>
                                            <a href="{{ url('/admin/photo/' . $item->id) }}" title="View Photo"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/admin/photo/' . $item->id . '/edit') }}" title="Edit Photo"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                            {!! Form::open([
                                                'method'=>'DELETE',
