...
</div><div class="form-group {{ $errors->has('pseudo') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('confirmation_token') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('password_requested_at') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('last_login') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('date_naiss') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('discipline') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('pays') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('ville') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('salt') ? 'has-error' : ''}}">
...
</div><div class="form-group {{ $errors->has('user_status_id') ? 'has-error' : ''}}">
